...
function createMenuItem(item, name, cost, category){
    item = {name, cost, category};
    return item;
}

console.log(createMenuItem('veggieBurger','Veggie Burger', 21, "Healthy"));

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
console.log(createMenuItem('italianSoda', 'Italian Soda', 8, "Beverage"));
console.log(createMenuItem('chocolateMilkshake', 'Chocolate Milkshake', 12, "Beverage"));
console.log(createMenuItem('lettuceCups', 'Lettuce Cups', 8, "Appetizer"));


/* Task 2: You're having a lunch special! 25% off for teachers and students, 10% off for everyone else. Add a method to your burger object that automatically calculates price given 
...
console.log(addReview(reviews, 'Chayce', 3.2, 'My server didnt even wipe the table down but she sure made up for it with strong drinks and a free ice cream sundae'));
...
function getReviewByIndex(arr, index) {
    return `${arr[index].name} gave this restaurant a ${arr[index].rating} review and their feedback was: ${arr[index].feedback}`;
  }
...
function getLastReview(arr) {
    let index = (reviews[reviews.length -1]);
    return `${arr[index].name} gave this restaurant a ${arr[index].rating} review and their feedback was: ${arr[index].feedback}`;
